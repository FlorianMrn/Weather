    ...
    return (
        <nav className="w-full h-12 bg-white z-1 bottom-0 flex justify-around absolute box-border bg-gray-100">
            <div className="relative flex justify-center flex-col items-center cursor-pointer box-border">
                <NavLink to="/" className="relative flex justify-center flex-col items-center cursor-pointer box-border" activeStyle={active}>
                    <WiDaySunny />
                    <div className="text-black">Méteo</div>
                </NavLink>
            </div>
            <div className="relative flex justify-center flex-col items-center cursor-pointer box-border">
                <NavLink to="/prévisions" className="relative flex justify-center flex-col items-center cursor-pointer box-border" activeStyle={active}>
                    <WiEarthquake />
