...
export const Nav = ({isAuthenticated, user, loading, errors, loadingAuth, registerAuth, loginAuth, message, errorsAuth, favs, sendDeleteData, disconnect, getFavs, getValue, sendRequestPixa, sendRequestOpen, load}) => {
    ...
    return (
        ...
        <>
            ...
            <div className="w-full h-full flex justify-center mt-16 overflow-hidden">
                ...
                :   <Fav favs={favs} sendDeleteData={sendDeleteData} getFavs={getFavs} getValue={getValue} sendRequestOpen={sendRequestOpen} sendRequestPixa={sendRequestPixa} load={load}/>
                }
            </div>
        </>
